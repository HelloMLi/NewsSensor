...
public class TopicService {
	...
	public void save(Stopic topic)
	{
		...
		db.execSQL("insert into topics(id,name,value) values(?,?,?)",
...
//	}
	...
	{
		SQLiteDatabase db=dbopenHelper.getWritableDatabase();
		db.execSQL("update topics set name=?,value=? where id=?",
	...
	public Stopic find(int id)
	{
		...
		Cursor cursor=db.rawQuery("select * from topics where id=?", new String[]{new Integer(id).toString()});
